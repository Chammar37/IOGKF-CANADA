				...
				<div class="single-event-info clearfix">
					<div class="container">
						...
						<?php if($event_settings['event_book_appointment_url']!=''){ ?>
							<a class="appointment-btn btn-eff" href="<?php echo esc_url($event_settings['event_book_appointment_url']); ?>"><i class="fa fa-pencil-square-o"></i><?php echo esc_attr($event_settings['event_book_appointment']); ?></a>
						<?php }else{ ?>
